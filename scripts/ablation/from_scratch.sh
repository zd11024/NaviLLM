...
torchrun --nnodes=1 --nproc_per_node=8 --master_port 41000 train.py \
    ...
    --data_dir data --pretrained_model_name_or_path data/models/Vicuna-7B --precision amp_bf16 --from_scratch \
    ...
    --max_saved_checkpoints 1 --output_dir build/ablation/from_scratch