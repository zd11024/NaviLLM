...
torchrun --nnodes=1 --nproc_per_node=8 --master_port 41000 train.py \
    --stage multi --cfg_file configs/held_out/held_out_reverie.yaml \
    ...
    --test_datasets CVDN SOON R2R REVERIE \
    --max_saved_checkpoints 1 --output_dir output/held_out/held_out_reverie